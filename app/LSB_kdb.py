...
def LSB_kdb_embedding(
    ...
    """
    Погружение в НЗБ с использованием метода Куттера-Джордана-Боссена.
    ...
    key: int = 42
        кюч для инициализации ГСПЧ для случайного выбора пикселей, в которые будет производиться погружение
    """
...
def LSB_kdb_extracting(
    ...
    """
    Извлечение из НЗБ вложения, погруженного с использованием метода Куттера-Джордана-Боссена.
